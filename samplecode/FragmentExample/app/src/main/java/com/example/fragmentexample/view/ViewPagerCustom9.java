...
public class ViewPagerCustom9  extends ViewPager {
    ...
    //For Indicator
    private LoopingViewPager.IndicatorPageChangeListener indicatorPageChangeListener;
    ...
    public ViewPagerCustom9(Context context) {
        super(context);
        init();
    }

    public ViewPagerCustom9(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (aspectRatio > 0) {
            ...
            int height = Math.round((float) View.MeasureSpec.getSize(widthMeasureSpec) / aspectRatio);
    ...
    public void setIndicatorPageChangeListener(LoopingViewPager.IndicatorPageChangeListener callback) {
