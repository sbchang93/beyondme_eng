...
public class RecyclerView81Activity extends AppCompatActivity {
    ...
    private void createActivityName () {
        ...
        activityName.add(position, "LayoutCustomLinearLayout01Activity - Custom LinearLayout");
        activityNameClassMap.put("LayoutCustomLinearLayout01Activity - Custom LinearLayout", LayoutCustomLinearLayout01Activity.class);
