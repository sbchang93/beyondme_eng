...
public class MultiTouchActivity extends AppCompatActivity {
    ...
    final int MAX_POINTER_COUNTER = 4;
    int id[] = new int[10]; // new int[3];
    int x[] = new int[10]; //new int[3];
    int y[] = new int[10]; //new int[3];
    String result;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(pointer_count > MAX_POINTER_COUNTER) pointer_count = MAX_POINTER_COUNTER;
