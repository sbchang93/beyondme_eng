...
public class SwipeViewDragHelper {
    ...
    public static SwipeViewDragHelper create(ViewGroup forParent, Callback cb) {
        return new SwipeViewDragHelper(forParent.getContext(), forParent, null, cb);
    }
    ...
    public static SwipeViewDragHelper create(ViewGroup forParent, float sensitivity, Callback cb) {
        final SwipeViewDragHelper helper = create(forParent, cb);
