package com.example.swipeup.view_utils;
...
public class ImageHelper {
    ...
    public static Bitmap handleImageEffect(final Bitmap bitmap,
                                           float hue,
                                           float saturation,
                                           float lum) {
        Bitmap _Bitmap = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), Bitmap.Config.ARGB_8888);
