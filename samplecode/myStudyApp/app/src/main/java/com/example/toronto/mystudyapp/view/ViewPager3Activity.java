...
// Reference Link Page : https://itpangpang.xyz/287?category=587498
...
public class ViewPager3Activity extends AppCompatActivity {
    ...
    private class pagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            switch(position) {
                case 0:
                    return new ViewPagerFirstFragment3();
                case 1:
                    return new ViewPagerSecondFragment3();
                case 2:
                    return new ViewPagerThirdFragment3();
                default:
                    return null;
            }
        }
