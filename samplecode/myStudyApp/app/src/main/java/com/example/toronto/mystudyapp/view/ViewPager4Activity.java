...
// Reference Link Page : https://itpangpang.xyz/288?category=587498
...
public class ViewPager4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vp.setOffscreenPageLimit(2); // Keep 2 pages
        vp.setCurrentItem(0);
    ...
    private class pagerAdapter extends FragmentStatePagerAdapter {
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            switch(position) {
                case 0:
                    return new ViewPagerFirstFragment4();
                case 1:
                    return new ViewPagerSecondFragment4();
                case 2:
                    return new ViewPagerThirdFragment4();
                default:
                    return null;
            }
        }
