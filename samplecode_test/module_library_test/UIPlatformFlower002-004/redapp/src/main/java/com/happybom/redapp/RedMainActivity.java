...
public class RedMainActivity extends BaseMainActivity {
    private static final String TAG = "RedMainActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.button.setText("Red Button");

        this.textView.setText("This is Red Apk");
    }
}
